class Ronk:
    ...
    def __init__(self,azon=0,fajta="",terfogat=0,ar=0,kategoria=""):
        self.azon=azon
        self.fajta=fajta
...
ronk5.ar=int(input("Kérem az árát:"))
...
azon=int(input("Kérem, adja meg egy rönk azonosítóját:"))
i=0
tovabb=True
while (tovabb):
...
fajl=open("pythonelovizsga/tolgy.txt","w",encoding="utf-8")
for egyRonk in ronkok:
